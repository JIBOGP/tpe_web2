...
<form action="updatecategory/{$category->id_categoria}" method="POST" enctype="multipart/form-data" class="my-4 ms-4 me-4">
    ...
    <div class="form-group my-2">
        ...
        <a href='editcategoryform/{$category->categoria}?cant_esp={$cant_esp-1}' class="fs-3" id="category_minus">-</a><span
            class="fs-3" id="category_cant">{$cant_esp}</span><a
            href='editcategoryform/{$category->categoria}?cant_esp={$cant_esp+1}' class="fs-3" id="category_plus">+</a>
        <tr>
